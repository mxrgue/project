{
  ...
  preloadImages().then(() => {
    // Initialize ImageTrail or any other image-related functionality
    new ImageTrail();

    // Apply the tilt effect to the images
    document.querySelectorAll(".content__img").forEach((img) => {
      img.addEventListener("mouseover", () => {
        img.style.transform = "rotate(10deg)"; // Tilt the image on mouseover
      });
    });
  });
}
